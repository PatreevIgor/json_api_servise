...
(0..4).each do |n|
  Post.create(title: Faker::Name.name, text: Faker::Name.name, user_id: rand(1..100), ip_address: ip_address_list[n])
end
...
500.times do
  Estimation.create(value: rand(1..5), post_id: rand(1..100))
end
